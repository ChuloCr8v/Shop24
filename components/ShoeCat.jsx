...
const ShoeCat = () => {
  ...
  useEffect(() => {
    ...
    const options = {
      ...
      params: {
        categoryID: 'fashion', 
        keyword: 'nike slides and sneakers', 
        country: 'US', page: '1'
      }, 
  ...
  return (
    <section className={styles.single_cat}>
       {loading ? <Loading /> : <div class={styles.container}>
        <Heading heading={"Luxury Shoes"} subtitle={"Check out our catalogue of luxury travel bags and designer bags from top brands"} />
        <div class={styles.products_container}>
          {shoeCategory.map((product, index) => (
